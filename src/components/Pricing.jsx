...
const plans = [
    ...
    },
    {
        ...
        price: '₹299',
        period: '/month',
        description: 'AI-powered analysis and query generation — what consultants charge ₹40,000+ for.',
        features: [
    ...
    },
    {
        ...
        price: '₹599',
        period: '/month',
        description: 'For serious authors and writing coaches managing multiple works.',
        features: [
            'Everything in Pro, plus:',
            'Novel editor with chapter manager',
            'AI writing assists (continue, rewrite, naming)',
