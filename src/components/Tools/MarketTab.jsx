...
export default function MarketTab() {
    ...
    const handleWc = useCallback((k, v) => setWc(v), [])
    ...
    return (
        <TabPanel>
            ...
            <div className="tool-fields">
                ...
                <MemoizedFieldInput label="Your Word Count (optional)" fieldKey="wc" type="number" value={wc} onChange={handleWc} placeholder="82000" />
            </div>
