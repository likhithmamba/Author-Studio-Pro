...
export default function FormatTab({ apiKey, aiModel, hasKey }) {
    ...
    const handleAuthor = useCallback((k, v) => setAuthor(v), [])
    const handleTitle = useCallback((k, v) => setTitle(v), [])
    ...
    return (
        <TabPanel>
            ...
            <div className="tool-fields">
                <MemoizedFieldInput label="Author Name" fieldKey="author" value={author} onChange={handleAuthor} placeholder="Jane Smith" required />
                <MemoizedFieldInput label="Manuscript Title" fieldKey="title" value={title} onChange={handleTitle} placeholder="The Lost Hours" required />
