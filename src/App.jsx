...
// ⚡ Bolt: Lazy load major route components to reduce initial JS bundle size.
// This splits the ~210kB main bundle into smaller chunks that load only when needed.
