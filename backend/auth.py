...
def get_password_hash(password: str) -> str:
    """Hash a password using bcrypt with a pre-hashed SHA-256 string to prevent the 72-byte limit DoS."""
    # Pre-hash with SHA-256 to avoid bcrypt 72-byte limit truncation
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    """Verify a password against its bcrypt hash (supports legacy and v2)."""
